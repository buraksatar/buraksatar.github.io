...
Watch this space: our newest benchmark, [Cultural Moment](/publications/cultural-moment/), is under review at EMNLP 2026.
...
Before SMU I spent five years at NTU and A\*STAR's Institute for Infocomm Research on an A\*STAR SINGA scholarship, working on semantic, debiased and moment-level text-video retrieval. I grew up in Bursa, studied on exchange in Siena and Naples (Italy), worked in Valencia (Spain) and Istanbul (Türkiye), and have lived in Singapore since 2020. I have often been the person in the room who does not get the reference. The difference is that I knew it. The models I test do not.
